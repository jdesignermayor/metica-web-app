...
export async function getSuggestions({ databaseInfo }: { databaseInfo: NotionDatabasePropertiesType }): Promise<Array<MistralSuggestionsType | []> | undefined> {
    ...
    //             }, {
    //                 role: "user",
    //                 content: "give me suggestions in this mandatory format: [{ chart_type: type, versus: val1-vs-val2, suggestion }] about what charts can i generate whit that data, please respond in json format, do not add comments."
    //             }]
    //         })
    //     })
